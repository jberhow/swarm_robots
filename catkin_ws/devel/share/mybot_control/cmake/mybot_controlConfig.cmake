...
if("TRUE" STREQUAL "TRUE")
  set(mybot_control_SOURCE_PREFIX /home/jeff/catkin_ws/src/mybot_control)
  set(mybot_control_DEVEL_PREFIX /home/jeff/catkin_ws/devel)
  ...
  set(mybot_control_INSTALL_PREFIX /home/jeff/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gr <gr@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jeff/catkin_ws/src/mybot_control/${idir}'.  Ask the maintainer 'gr <gr@todo.todo>' to fix it.")
    endif()
